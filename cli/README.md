...
> You should write your schemas in a directory outside of `src/`. It will prevent errors while resolving the path of 
> files when generating import instructions.
> 
> Moreover, it will be easier for you to distinguish between schema declarations, code generated by schemas and the code
> of your application.
