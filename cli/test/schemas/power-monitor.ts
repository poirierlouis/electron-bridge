...
export type PowerMonitorEvent = 'suspend' | 'resume' | 'on-ac' | 'on-battery' | 'shutdown' | 'lock-screen' |
    'unlock-screen' | 'user-did-become-active' | 'user-did-resign-active';
...
export class PowerMonitor {
    ...
    public onShutdown(listener: Function): void {
